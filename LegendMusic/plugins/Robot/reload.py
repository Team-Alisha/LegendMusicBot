...
from LegendMusic.utils.database import get_authuser_names, get_cmode
from LegendMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from LegendMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Legend.stop_stream(message.chat.id)
    except:
        pass

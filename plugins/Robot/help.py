...
from LegendMusic.utils import help_pannel
from LegendMusic.utils.database import get_lang, is_commanddelete_on
from LegendMusic.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from LegendMusic.utils.inline.help import (help_back_markup,
                                          private_help_panel)
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_sticker("CAACAgUAAxkBAAN7Y0hMixtcrBljlYpJXo82YKBkEhgAAvICAAJVn9BUD7CVUBAFvksqBA")

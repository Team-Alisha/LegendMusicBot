...
from LegendMusic.utils import get_readable_time
from LegendMusic.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgEAAx0CXbvlWwACH-9jU4pgIf6cuBBOw-ESQS3frj6pdAACJwIAAjPb4EVYNenn2BRm4B4E")
